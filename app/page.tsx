    ...
    <main className="min-h-screen bg-[#0b1217] text-slate-200">
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 z-0">
          <DarkVeil hueShift={51} speed={0.75} noiseIntensity={0.11} warpAmount={1} />
        </div>

        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:pt-16 lg:pb-0 flex flex-col items-center text-center">
