...
export default function SidebarClient() {
  ...
  const nav = [
    ...
    { href: "/dashboard/submissions", label: "Submissions", icon: IconIntake },
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center gap-3 rounded-md px-3 py-2 text-sm border border-transparent hover:bg-slate-800/70 ${
                      active
                        ? "bg-slate-800/70 border-slate-700 text-emerald-400"
                        : "text-slate-300"
                    }`}
...
function IconHome(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      fill="currentColor"
      {...props}
      className={["size-4", props.className].filter(Boolean).join(" ")}
    >
      {/* size-4 fallback */}
...
function IconOrganization(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props} className={["size-4", props.className].filter(Boolean).join(" ")}>
...
function IconIntake(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
